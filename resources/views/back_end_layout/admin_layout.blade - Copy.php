		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="index.html"><i class="bx bx-right-arrow-alt"></i>Client Management</a></li>
						<li> <a href="active-supplier.html"><i class="bx bx-right-arrow-alt"></i>Supplier Management</a></li>
						<li> <a href="active-customer.html"><i class="bx bx-right-arrow-alt"></i>Customer Management</a></li>
