...
<div class="modal" id="myModal">
  <div class="modal-dialog modal-lg modal-dialog-centered">
            ...
            <div class="row">
               ...
               <!--  <input type="text" class="form-control form-control-sm" value="TL" name="last_name" id="dataftech_last_name" placeholder="Enter Your Last Name" disabled=""> -->
            	...
            	<div class="col-md-6">
            		<div class="row">
            			<div class="col-md-6">
                <label><b>Email (Official)*:</b></label>
                </div>
                <div class="col-md-6">
                	<p>dharmu@gmail.com</p>
               ...
               <!--  <input type="text" class="form-control form-control-sm" value="7376469215" name="phone" id="dataftech_phone" placeholder="Enter Your Phone" disabled=""> -->
            	...
            	<div class="col-md-6">
            		<div class="row">
            			<div class="col-md-6">
                <label><b>Achievement till date:</b></label>
                </div>
                <div class="col-md-6">
                	<p>Rs 0</p>
            	...
            	<div class="col-md-6">
            		<div class="row">
            			<div class="col-md-6">
                <label><b>Interested Customer:</b></label>
                </div>
                <div class="col-md-6">
                	<p>0</p>
            	...
            	<div class="col-md-6">
            		<div class="row">
            			<div class="col-md-6">
                <label><b>Not Interested Customer:</b></label>
                </div>
                <div class="col-md-6">
                	<p>150</p>
	...
	new ApexCharts(document.querySelector("#chart5"), e).render(), Highcharts.chart("chart6", {
		...
		title: {
			text: "Total Customer {{$Customer}} January, 2020"
		},
		accessibility: {
			announceNewData: {
				enabled: !0
  ...
  $.ajax({
            ...
            success: function(result) {
             for (i = 0; i < result.data.length; i++) {
                   ...
                   alert("Next upcoming meeting with "+result.data[i].customer_name+" at" +result.data[i].follow_up_date);
                }
            }
        });         
	},9000);   
